#This script was used to plot the heatmap for DESeq2 results from DSS datasets group A (figure 3.10).
...
ps <- phyloseq(otu_table(OTU, taxa_are_rows=FALSE), tax_table(taxamatrix), 
...
write.table(metadata2, file = "metadata_fully_clustering_DSS_MMUPHin(adjusted).txt", sep="\t")
...
write.csv(deseq2_table, "DESeq2_table_fully_Clustering_DSS(Condition)_MMUPHin.csv")
...
rows <- c("f_Peptostreptococcaceae", "g_Escherichia/Shigella", "g_Mailhella", 
          "g_Faecalicatena", "g_Mucispirillum", "g_Clostridium XIVb", "g_Enterococcus", 
          "g_Caproiciproducens", "f_Eubacteriaceae", "g_Sporobacter", "g_Hungatella", 
          "g_Murimonas", "g_Anaeroplasma", "g_Eisenbergiella", "g_Lactococcus", "g_Blautia", 
          "g_Ileibacterium", "g_Dysosmobacter", "g_Butyrivibrio", "g_Terrisporobacter", 
          "o_Desulfovibrionales", "c_Alphaproteobacteria", "g_Mediterraneibacter", 
          "g_Criibacterium", "f_Rhodospirillaceae", "g_Tepidibaculum", "g_Acetanaerobacterium",
          "g_Christensenella", "g_Lactobacillus", "g_Ruminococcus", "g_Parabacteroides", 
          "p_Candidatus_Saccharibacteria")
...
pdf(file="DESeq2_DSS_FC_MMUPHin(Condition+simplelabels+log10).pdf", height=8, width = 15)
